                        ...
                        <form action="{{route("user-management.users.store")}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputText1"
                                       value="{{old("name")}}" placeholder="Enter Name" required name="name">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail3">Email</label>
                                <input type="email" class="form-control" id="exampleInputEmail3"
                                       value="{{old("email")}}" placeholder="Enter Email" required name="email">
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <div class="w-100 position-relative">
                                    <input type="password" required class="form-control" id="password" value="{{old("password")}}" name="password">
